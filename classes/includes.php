...
include 'deathbycaptcha.php';

class Proxy
{
    public $needToChange = false;
    private $proxyList = [];
    private $index = 0;
    /**
     * @var Proxy
    ...
    {
        $proxies = file_get_contents('./txt/proxy');
...
include 'AlreadyExist.php';
include 'MyHabit.php';
include 'AmazonUS.php';
include 'AmazonUK.php';
